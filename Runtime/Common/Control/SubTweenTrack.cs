...
//     public class SubTweenTrack : TweenTrack<PlayableDirector, SubTweenMixerBehaviour>
//     {
// #if UNITY_EDITOR
...
//     
//     [Serializable]
//     public class SubTweenMixerBehaviour : TweenMixerBehaviour<PlayableDirector>
//     {
...
//         {
//             if (activationType.Value == ActivationType.DoNothing) return;
//
//             bool active = activationType.Value == ActivationType.ActiveOnStart && HasAnyClipStarted(playable)
//                           || activationType.Value == ActivationType.ActiveWhilePlaying && IsAnyClipPlaying(playable);
//
//             Target.gameObject.SetActive(active);
//         }
//
//         protected override void OnEnd(Playable playable)
//         {
